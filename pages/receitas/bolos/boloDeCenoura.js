  ...
  return (
    <div>
      <Recipe
        ...
        picture="https://img.itdg.com.br/tdg/images/recipes/000/000/023/351097/351097_original.jpg?mode=crop&width=350&height=250"
        time="40 min"servings="8 porções">
        <h2>Ingredientes</h2>
        <h3>Massa</h3>
        <ul>
          <li> 2 xicara (cha) de açucar </li>
          <li> 1/2 xícara (chá) de óleo </li>
          <li> 3 cenouras médias raladas </li>
          <li> 4 ovos</li>
          <li> 2 xícaras (chá) de açúcar </li>
          <li> 1/2 xícaras (chá) de farinha de trigo </li>
          <li> 1 colher (sopa) de fermento em pó </li>
        </ul>
        <h3>Cobertura</h3>
        <ul>
          <li>1/2 xicara (cha) de açucar</li>
          <li>1/2 xícara (chá) de óleo</li>
          <li>3 cenouras médias raladas</li>
          <li>4 ovos</li>
          <li>2 xícaras (chá) de açúcar</li>
