...
export default function BolinhoDeChuva() {
    return (
        <div>
            ...
            picture = 'https://img.itdg.com.br/tdg/images/recipes/000/004/683/38653/38653_original.jpg?mode=crop&width=710&height=400'
            time = '30 min'
            servings = '8 porções'
            >
                <h2>Ingredientes</h2>
                    <ul>
                       ...
                       <li>2 xícaras e 1/2 (chá) de farinha de trigo</li>
